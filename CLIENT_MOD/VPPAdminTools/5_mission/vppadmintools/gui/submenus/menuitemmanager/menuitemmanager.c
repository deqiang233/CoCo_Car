class MenuItemManager extends AdminHudSubMenu
{
	...
	private const ref array<string> m_CatagoryLabels = {"#VSTR_CATEGORY_ALL","#VSTR_CATEGORY_EDIBLE","#VSTR_CATEGORY_TRANSPORT","#VSTR_CATEGORY_WEAPON","#VSTR_CATEGORY_CLOTHING","#VSTR_CATEGORY_HOUSE","#VSTR_CATEGORY_AI"};
	...
	for (int i = 0; i < m_CatagoryItems.Count(); i++){
		m_ComboCatagory.AddItem(m_CatagoryLabels.Get(i));
	}
	SetSearchCatagory();
	UpdateFilter();
