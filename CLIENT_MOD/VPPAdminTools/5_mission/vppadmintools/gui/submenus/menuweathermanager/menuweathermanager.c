class MenuWeatherManager extends AdminHudSubMenu
{
	...
	override void OnCreate(Widget RootW)
	{
		...
		m_TimePresetsInstance = new VPPDropDownMenu( m_TimePresetsDropDown, "#VSTR_TIME_PRESETS" );
		...
		m_WeatherPresetsDropDownInstance  = new VPPDropDownMenu( m_WeatherPresetsDropDown, "#VSTR_WEATHER_PRESETS" );
