class VPPFilterEntry : VPPPlayerTemplate
{
    ...
    void VPPFilterEntry(GridSpacerWidget grid, EspFilterProperties props, bool startCheck = false)
    {
        ...
        string localizedName = GetLocalizedFilterName(props.filterType);
        m_FilterToggle.SetText(localizedName);
    ...
    string GetLocalizedFilterName(string filterType)
    {
        string key = "#VSTR_FILTER_" + filterType;
        return key;
    }
