...
class VPPAdminHud extends VPPScriptedMenu
{
	...
	InsertButton("MenuPlayerManager", "#VSTR_MENU_PLAYERMANAGER", "set:dayz_gui_vpp image:vpp_icon_players", "#VSTR_TOOLTIP_PLAYERMANAGER");
	InsertButton("MenuItemManager", "#VSTR_MENU_ITEMMANAGER", "set:dayz_gui_vpp image:vpp_icon_item_manager", "#VSTR_TOOLTIP_ITEMMANAGER");
	InsertButton("MenuTeleportManager", "#VSTR_MENU_TELEPORTMANAGER", "set:dayz_gui_vpp image:vpp_icon_teleport_manager", "#VSTR_TOOLTIP_TELEPORTMANAGER");
	InsertButton("EspToolsMenu", "#VSTR_MENU_ESPTOOLS", "set:dayz_gui_vpp image:vpp_icon_esp", "ESP/XRay");
	InsertButton("MenuCommandsConsole", "#VSTR_MENU_CONSOLE", "set:dayz_gui_vpp image:vpp_icon_cmd_console", "#VSTR_TOOLTIP_COMMANDSMENU");
	InsertButton("MenuServerManager", "#VSTR_MENU_SERVERMANAGER", "set:dayz_gui_vpp image:vpp_icon_settings", "#VSTR_TOOLTIP_SERVERMANAGER");
	InsertButton("MenuWeatherManager", "#VSTR_MENU_WEATHERMANAGER", "set:dayz_gui_vpp image:vpp_icon_cloud", "#VSTR_TOOLTIP_WEATHERMANAGER");
	InsertButton("MenuObjectManager", "#VSTR_MENU_OBJECTMANAGER", "set:dayz_gui_vpp image:vpp_icon_obj_editor", "#VSTR_TOOLTIP_OBJMANAGER");
	InsertButton("MenuBansManager", "#VSTR_MENU_BANSMANAGER", "set:dayz_gui_vpp image:vpp_icon_bans_editor", "#VSTR_TOOLTIP_BANSMANAGER");
	InsertButton("MenuPermissionsEditor", "#VSTR_MENU_PERMISSIONSEDITOR", "set:dayz_gui_vpp image:vpp_icon_perms_editor", "#VSTR_TOOLTIP_PERMSEDITOR");
	InsertButton("MenuWebHooks", "#VSTR_MENU_WEBHOOKS", "set:dayz_gui_vpp image:vpp_icon_webHooks", "#VSTR_TOOLTIP_WEBHOOKS");
	InsertButton("MenuXMLEditor", "#VSTR_MENU_XMLEDITOR", "set:dayz_gui_vpp image:vpp_icon_xml_editor", "#VSTR_TOOLTIP_XMLEDITOR");
		DefineButtons();
		//----
